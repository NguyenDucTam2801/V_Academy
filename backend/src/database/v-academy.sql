...
INSERT INTO `amission` (`amission_id`, `amission_name`, `amission_birth`, `amission_email`, `amission_phone`, `amission_address`, `amission_url`, `amission_region`, `isActivation`) VALUES
('ami_001', 'Chloe Adams', '1980-09-10', 'chloe.adams@example.com', '3334445555', '202 Birch St.', NULL, 'East Region', 1),
('ami_002', 'David Green', '1982-11-22', 'david.green@example.com', '4445556666', '303 Cedar St.', NULL, 'West Region', 1);
...
INSERT INTO `amission_account` (`amission_id`, `amission_userName`, `amission_password`) VALUES
...
INSERT INTO `class` (`class_id`, `class_name`, `class_numberOfLessons`, `class_description`, `subject_id`, `course_id`, `tutor_id`, `class_isFinished`, `class_numberOfOccupiedClass`, `student_id`, `amission_id`) VALUES
('class_001', 'Basic English Class 1', 10, 'Morning class for beginners', 'eng_sub', 'course_eng_001', 'tut_001', 0, 5, 'stu_001', 'ami_001'),
('class_002', 'Advanced English Class 1', 10, 'Evening class for advanced learners', 'eng_sub', 'course_eng_002', 'tut_002', 0, 3, 'stu_002', 'ami_002');
...
INSERT INTO `course_tutor` (`subject_id`, `tutor_id`, `course_id`) VALUES
...
('lesson_001', 'Lesson 1: Basic Greetings', 'Introduction to common greetings in English', NULL, 'https://pwr.edu.zoom.us/j/13asdf55-aADF312', '2024-10-16 15:50:22', '2024-10-16 10:00:00'),
('lesson_002', 'Lesson 2: Basic Verbs', 'Introduction to essential verbs in English', NULL, 'https://pwr.edu.zoom.us/j/aisufhqn-fasdfkjq-46fd6dgh', '2024-10-16 15:50:50', '2024-10-17 10:00:00'),
('lesson_003', 'Lesson 1: Advanced Grammar', 'In-depth look at complex grammatical structures', NULL, 'https://pwr.edu.zoom.us/j/fauhooiqjp-sf32AF6543-agoqwga9', '2024-10-16 15:51:19', '2024-10-16 19:00:00'),
('lesson_004', 'Lesson 2: Advanced Vocabulary', 'Study of advanced vocabulary in context', NULL, 'https://pwr.edu.zoom.us/j/faiubiouawd-653asgAFsg-ioanpow6JH', '2024-10-16 15:51:44', '2024-10-17 19:00:00');
...
('stu_001', 'John Doe', '2005-05-15', 'john.doe@example.com', '1234567890', '123 Elm St.', NULL, 'A diligent student'),
('stu_002', 'Jane Smith', '2004-12-30', 'jane.smith@example.com', '0987654321', '456 Oak St.', NULL, 'An eager learner'),
('stu_004', 'Michael Green', '2003-11-25', 'michael.green@example.com', '5556667777', '321 Cedar St.', NULL, 'New student in the academy'),
('stu_005', 'Michael Jackson', '2003-12-30', 'michael.jackson@example.com', '5556668888', '300 Cedar St.', NULL, 'New student in the academy 1');
...
('tut_001', 'Alice Johnson', '1985-07-20', 'alice.johnson@example.com', '1112223333', 'North Region', '789 Pine St.', NULL, 'Experienced English tutor', 1, 'eng_sub'),
('tut_002', 'Bob Brown', '1990-08-05', 'bob.brown@example.com', '2223334444', 'South Region', '101 Maple St.', NULL, 'Specialized in advanced English', 1, 'eng_sub');
...
--
ALTER TABLE `amission`
  ADD PRIMARY KEY (`amission_id`);

--
-- Indexes for table `amission_account`
--
ALTER TABLE `amission_account`
  ADD PRIMARY KEY (`amission_id`);
...
ALTER TABLE `course_tutor`
  ADD PRIMARY KEY (`subject_id`,`tutor_id`,`course_id`),
...
--
ALTER TABLE `amission_account`
  ADD CONSTRAINT `fk_amission_account_amission` FOREIGN KEY (`amission_id`) REFERENCES `amission` (`amission_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `class`
--
ALTER TABLE `class`
  ADD CONSTRAINT `fk_class_amission` FOREIGN KEY (`amission_id`) REFERENCES `amission` (`amission_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `class_lesson`
  ADD CONSTRAINT `fk_class_lesson_class` FOREIGN KEY (`class_id`) REFERENCES `class` (`class_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `course_tutor`
  ADD CONSTRAINT `fk_course_tutor_course` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`),
...
--
ALTER TABLE `student_account`
  ADD CONSTRAINT `fk_student_account_student` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `tutor_account`
  ADD CONSTRAINT `fk_tutor_account_tutor` FOREIGN KEY (`tutor_id`) REFERENCES `tutor` (`tutor_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
