...
export default function ContactPage() {
  const CONTACT_URL = "http://localhost:3001/api/customer/contact";
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    ...
    >
      ...
      <div className="register-container">
        ...
        <p>
          Please complete the form below. V-academy will contact you to answer
          any questions, completely free of charge.
        </p>
